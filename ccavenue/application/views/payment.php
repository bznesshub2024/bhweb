	...
	<div class="container">
		...
		<div class="row" style="height:0px !important; min-height:0px !important; width:0; padding:0">
			<div class="col-md-12" style="height:0px !important; min-height:0px !important; width:0; padding:0">
				<form method="post" name="ccavenue_checkout" action="index.php/Welcome/save" style="height:0px !important; width:0; padding:0">
					...
					<table width="40%" height="100" align="center" class="table" style="border:1px solid blue; height:0px !important; width:0;">
						...
						<input type="hidden" name="redirect_url" value="https://www.marurang.in/ccavenue/welcome/redirect" />
						<input type="hidden" name="cancel_url" value="https://www.marurang.in/ccavenue/welcome/cancel" />
