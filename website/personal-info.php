					...
					<div class="left-block box-shadow" id="MyProfile">
						...
						<form class="form row g-3">
							<div class="col-md-7">
								...
								<input type="text" class="form-control" placeholder="Name" value="Sachin" disabled />
							</div>
							<div class="col-md-7">
								<label class="form-label">Email Address</label>
								<input type="email" class="form-control" placeholder="Email" value="abcdef@email.com" disabled />
							</div>
							<div class="col-md-7">
							  <label class="form-label">Phone no</label>
							  <input type="text" class="form-control" placeholder="Phone no" value="+91-7248963542" disabled />
							</div>
