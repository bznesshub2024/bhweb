...
<main class="coupon-page notification-page my-order-page cart-page">
					...
					<div class="left-block box-shadow" id="MyProfile">
						...
						<div class="notifications">
							...
							<div class="row">
								<div class="col-md-9">
									<div class="details">
										<h6>Get additional 7% off upto ₹</h6>
										<p>Get extra 7% off upto ₹500 on 1 item(s) (price inclusive of cashback/coupon)</p>
									</div>
								</div>
								<div class="col-md-3">
									<div class="view-wrap">
										<p>Valid till 28 Feb, 2023</p>
										<a href="javascript:void(0);">View T&C</a>
									</div>
								</div>
							</div>
							<hr/>
