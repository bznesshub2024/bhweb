...
defined('MOBILE')      OR define('MOBILE', '600-600'); // image size for mobile
...
defined('SITE_URL')      OR define('SITE_URL', 'https://www.marurang.in/website/'); // 

defined('MEDIA_URL')      OR define('MEDIA_URL', 'https://www.marurang.in/website/media/'); // 
