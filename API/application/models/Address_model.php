...
class Address_model extends CI_Model {
   ...
   //Functiofor for add product into cart
    function add_user_address($username,$mobile,$pincode,$user_id,$locality,$fulladdress,$state, $city, $addresstype,$email,$lat,$lang,$city_id,$state_id){
		...
		if($query1->num_rows() >0){
			...
			if($query->num_rows() >0){
				...
				$address_json_array =	array(
						...
						'lat' => $lat,
						'lang' => $lang ,'city_id' => $city_id,'state_id' => $state_id );
