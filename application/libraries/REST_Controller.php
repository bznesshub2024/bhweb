...
abstract class REST_Controller extends CI_Controller {
    ...
    public function __construct($config = 'rest')
    {
		...
		$this->load->model('Home_model');
		 ...
		 $this->data['header_default'] = $this->category_model->get_header_category_default_request($this->session->userdata("default_language"),2);
		 $this->data['header_cat_mobile'] = $this->category_model->get_header_category_mobile_request($this->session->userdata("default_language"),2);
