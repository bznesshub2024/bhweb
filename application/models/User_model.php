       ...
       $user_result = array();
		...
		if($query->num_rows() >0){
		   ...
		   die();
			...
			$data['fullname'] = ucwords($user_name);
            ...
            $this->db->select('*');
		    $this->db->where(array('phone' => $user_result1->phone));
		    $query_m = $this->db->get('sellerlogin');
			...
			$user_result['is_seller'] = $is_seller;
			...
			$user_result['referral_code'] = $user_result1->referral_code;
