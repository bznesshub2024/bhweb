		...
		<div class="right-block">
			<div class="wrap box-shadow">
				<div class="wrap-block align-items-center">
					<img src="<?php echo base_url; ?>/assets_web/images/icons/userprofile.png" class="" />
			...
			<div class="wrap box-shadow">
				<div class="wrap-block">
					...
					<div class="wrap-details">
						<h5 class="text-blue">Account Settings</h5>
						<h6><a href="<?php echo base_url; ?>personal_info">
								<h6>Personal Information
							</a></h6>
						<h6><a href="<?php echo base_url; ?>user-wallet">My Wallet</a></h6>
						<h6><a href="<?php echo base_url; ?>myaddress">Manage Addresses</a></h6>
						<h6><a href="<?php echo base_url; ?>bank-details">Manage Bank Account</a></h6>
					</div>
				</div>
				<hr />
				<div class="wrap-block">
					<!-- <img src="<?php echo base_url; ?>/assets_web/images/icons/order.png" class="" /> -->
					<i class="fa-solid fa-box fa-xl mt-3" style="color: #0e0e86; width: 28px;"></i>
					<div class="wrap-details">
						<h5 class="text-blue">My Orders</h5>
						<h6><a href="<?php echo base_url; ?>order">
								<h6>All Orders
							</a></h6>
						<h6><a href="<?php echo base_url ?>track">
								<h6>Track Order
							</a></h6>
							<h6><a href="<?php echo base_url ?>tree_view">
							<h6>My Partner View
						</a></h6>
					</div>
				</div>
				...
				<img src="<?php // echo base_url;
							?>/assets_web/images/icons/credit-card.png" class="" />
				<div class="wrap-details">
					<h5>Payments</h5>
			...
			<hr/>-->
				<div class="wrap-block">
					<img src="<?php echo base_url; ?>/assets_web/images/icons/mystuff.png" class="" style="height: 24px;" />
					<div class="wrap-details">
						<h5 class="text-blue">My Stuff</h5>
						<h6><a href="<?php echo base_url; ?>notification">
								<h6>All Notifications
							</a></h6>
						<h6><a href="<?php echo base_url; ?>wishlist">
								<h6>My Wishlist
							</a></h6>
					</div>
				</div>
				<hr />
				<div class="wrap-block">
					<img src="<?php echo base_url; ?>/assets_web/images/icons/logout.png" style="height: 25px;" />
					<div class="wrap-details">
						<h5><a class="text-blue" href="<?php echo base_url; ?>logout">Logout</a></h5>
					</div>
				</div>
			</div>

			<div class="wrap box-shadow mt-0 pt-1">
