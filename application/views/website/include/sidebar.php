      ...
      $.ajax({
		...
		<div class="wrap box-shadow">
			...
			<div class="wrap-block">
				...
				<i class="fa-solid fa-box fa-xl mt-4" style="color: #0e0e86; width: 28px;"></i>
				<div class="wrap-details">
			...
			<hr />
			<div class="wrap-block">
				<img src="<?php echo base_url; ?>/assets_web/images/icons/logout.png" class="" style="height: 25px;" />
				<div class="wrap-details">
		...
		<div class="wrap box-shadow mt-0 pt-1">
			<h6><a href="<?php echo base_url ?>/faq">
					<h6>Help Center
				</a></h6>
		</div>
