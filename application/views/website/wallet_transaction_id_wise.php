...
<body>
	...
	<input type="hidden" id="wallet_id" value="<?php echo $wallet_id; ?>">
    <main>
        <section class="px-sm-0 px-md-4">
            <div class="col-sm-12 col-md-12">
                <div class="mt-md-12 mt-5">
                    <div class="row mx-1">
                                    ...
                                    <div class="flex-sm-row flex-column d-flex">
                                        <div class="col-sm-12 col-12 px-0">
                                            <div class="input-group input-daterange">
                                                ...
                                                <submit class="btn btn-default btn-radious" onclick="search_data()" id="name" name="submit">search</button>
                                            </div>
                                        </div>
                                    </div>
                                </form>
                    ...
                    <div class="main_container mt-3 border">
                        <div class="container my-2 data-div">
                            <div class="fix_month_height" id="history_data">
                                <?php if(!empty($wallet_summery)) { foreach ($wallet_summery as $wallet_summery_data) {
    ...
    <script>
        ...
        function search_data() {
            ...
            $.ajax({
                method: "post",
                url: site_url + "search_wallet_data_id_wise",
                data: {
