        ...
        success: function (response) {
            ...
            $(data).each(function () {
                ...
                if (this.payment_type == 1) {
                    not_withdrow = "<span style='font-size:10px;color:red'> (Can't Withdraw)</span>";
                }
				
				
				
                var html = '<tr id="tr' + this.id + '"> <td>' + count + '</td><td > ' + this.transaction_id + '</td><td > ' + ttype + '</td><td > ' + this.amount + '</td><td > ' + this.user_name + '</td><td > ' + this.remark + not_withdrow +'</td><td > ' + this.created_at + '</td>';
                html += '</tr>';
