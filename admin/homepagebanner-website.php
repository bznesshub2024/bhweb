							...
							<section id="featured" class="featured homehero">
								<div class="container">
									<div class="row">
										...
										?>
										<div class="col-lg-4 mb-2 tooltips">
											<span class="tooltiptext">Banner Size 700*300</span>
											<div class="icon-box" style="height:150px; background-image: url('<?= $section1_image1; ?>');background-size: contain;background-repeat: no-repeat;background-position: left;">
										...
										<div class="col-lg-4 mb-2 tooltips">
											<span class="tooltiptext">Banner Size 700*300</span>
											<div class="icon-box" style="background: linear-gradient(#31AADE, #2825AD);height:150px; background-image: url('<?= $section1_image2; ?>');background-size: contain;background-repeat: no-repeat;background-position: left;">
										...
										<div class="col-lg-4 mb-2 tooltips">
											<span class="tooltiptext">Banner Size 700*300</span>
											<div class="icon-box" style="height:150px; background-image: url('<?= $section1_image3; ?>');background-size: contain;background-repeat: no-repeat;background-position: left;">
							...
							<section>
								<div class="container">
									<div class="col-lg-12">
										...
										<div class="row">
											<div class="section-header tooltips">
											<span class="tooltiptext">Banner Size 1150*450</span>
							...
							<section id="portfolio" class="portfolio mt-2">
								<div class="container">
									...
									<div class="row mt-5">
										...
										<div class="col-md-12 portfolio-item filter-app">
											<div class="section-header portfolio-wrap p-2 tooltips">
											<span class="tooltiptext">Banner Size 1150*450</span>
							...
							<section class="sector">
								<div class="container">
									<div class="row">
										...
										<div class="col-lg-4 text-light mb-2 tooltips">
											<span class="tooltiptext">Banner Size 600*500</span>
										...
										<div class="col-lg-4 text-light mb-2 tooltips">
											<span class="tooltiptext">Banner Size 600*250</span>
