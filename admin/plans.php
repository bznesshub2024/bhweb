              ...
              <div data-example-id="simple-form-inline">
                ...
                <div class="row align-items-center">
                  ...
                  <div class="col-md-6 mb-2">
                    ...
                    <button type="button" class="btn btn-danger waves-effect waves-light" id="" data-toggle="modal" data-target="#myModal">Add Plans</button>
      ...
      <div class="modal-body">
        ...
        <form class="form" id="add_attribute_form" enctype="multipart/form-data">
		  ...
		  <div class="form-group">
            ...
            <input type="number" class="form-control" id="plan_value" placeholder="Plan Value (Price)">
      ...
      <div class="modal-body">
        ...
        <form class="form" id="update_brand_form" enctype="multipart/form-data">
		 ...
		 <div class="form-group">
            ...
            <input type="number" class="form-control" id="update_plan_value" placeholder="Plan Value (Price)">

          </div>
          

          <input type="hidden" class="form-control" id="plan_id">
