<!--footer-->
<div class="footer">
	<p class="text-center mb-0">&copy; <?php echo date('Y'); ?> BznessHub. All Rights Reserved | Design and developed by <a href="https://www.blueappsoftware.com/" class="text-dark" target="_blank">BznessHub IT Team</a></p>
</div>
<!--//footer-->
</div>
