...
<script src ="js/admin/manage_return_policy.js"></script>
		...
		<div id="page-wrapper">
		 ...
		 <div class="work-progres">
            ...
            <h4 class="widget-title"><b>All Return Policy </b> <button type="button" class="btn btn-primary" id="" data-toggle="modal" data-target="#myModal">Add Return Policy</button>
		</h4>
  ...
  <div class="modal-dialog" style="width:50%;">
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title">Add Return Policy</h4>
      </div>
      <div class="modal-body"> 
		<form class="form" id="add_policy_form"  enctype="multipart/form-data">
            ...
            <button type="submit" class="btn btn-success" value="Upload" href="javascript:void(0)" id="add_policy_btn">Add</button> 
		</form> 
      </div>
