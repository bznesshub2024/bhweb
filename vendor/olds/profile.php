...
<?php include("header.php"); 
        $cname=""; $fname=""; $address=""; $desc=""; $city=""; $pincode =""; $state=""; $country=""; $phone=""; $email="";$logo="";$website=""; $tax=""; 
        $grpid=""; $status=""; $flagid=""; $createby=""; $update_by=""; $pan_card="";  $aadhar_card= $pan_number= $cin_number =$seller_banner= ""; 
		...
		$data = $stmt->bind_result( $col1, $col2, $col3, $col4, $col5, $col6, $col7, $col8, $col9, $col10, $col11, $col12, $col13, $col14,
					$col15, $col17, $col18, $col19, $col20, $col21, $col22 , $col23, $col24, $col25 , $col26 );
       
		$return = array();
                            	   
        while ($stmt->fetch()) {    
            $cname=$col2; $fname=$col3; $address=$col4; $desc=$col5; $city=$col6;
            $pincode =$col7; $state=$col8; $country=$col9; $phone=$col10; 
            $email=$col11; $logo=$col12;  $website=$col13;  $tax=$col14;  $grpid=$col15; 
            $status=$col17;  $flagid=$col18;  $createby=$col19;  $update_by=$col20; $pan_card=$col21;  $aadhar_card=$col22; $business_proof=$col23; 
            $pan_number= $col24; $cin_number =$col25; $seller_banner =$col26;
        }
        					    ...
        					    <div class="form-three widget-shadow">
        							<form class="form-horizontal" id="myform">
        								...
        								<div class="form-group">
        									...
        									<div class="col-sm-8">
        										<input type="text" class="form-control1" id="seller_name" placeholder="Full Name" value="<?php echo $fname; ?>"  required>
        									</div>
        								</div>
        								<div class="form-group">
        									<label for="focusedinput" class="col-sm-2 control-label">Business Name **</label>
        									<div class="col-sm-8">
        										<input type="text" class="form-control1" id="business_name" placeholder="Business/ Company Name" value="<?php echo $cname; ?>"  required>
        									</div>
        								</div>
        								<div class="form-group">
								        		<label  class="col-sm-2 control-label">Seller Type **</label>
								           	<div class="col-sm-8">
								               <select class="form-control1" id="sellergroup" name="sellergroup">
        								...
        								<div class="form-group">
        									<label for="focusedinput" class="col-sm-2 control-label">Business Address**</label>
        									<div class="col-sm-8">
        										<textarea rows="5" class="form-control" id="business_address" placeholder="Business Address" required><?php echo $address; ?></textarea>
        									</div>
        								</div>
        								<div class="form-group">
        									<label for="focusedinput" class="col-sm-2 control-label">Business Description **</label>
        									<div class="col-sm-8">
        								...
        								<div class="form-group">
        									...
        									<div class="col-sm-8">
        										<input type="text" class="form-control1" id="pincode" placeholder="462026" value="<?php echo $pincode; ?>" required>
        									</div>
        								</div>
        								<div class="form-group">
        									<label for="focusedinput" class="col-sm-2 control-label">Phone **</label>
        									<div class="col-sm-8">
        										<input type="text" class="form-control1" id="phone" placeholder="** without country code"  value="<?php echo $phone; ?>"required>
        									</div>
        								</div>
        								<div class="form-group">
        									<label for="focusedinput" class="col-sm-2 control-label">email Id **</label>
        									<div class="col-sm-8">
        										<input type="email" class="form-control1" id="email" placeholder="email id" value="<?php echo $email; ?>" required>
        									</div>
        								</div>
        								
                                         <div class="form-group">
                                             
                                            <label for="exampleInputFile" class="col-sm-2 control-label">Update Logo 500x500 pixel</label> 
                                             ...
                                             <div class="col-sm-8"> 
        								               <div class="input-files">
                                                         ...
                                                         <div >
                                                            ...
                                                            <input type="file" name="seller_logo" id="seller_logo" class="form-control1"  onchange="uploadFile1('seller_logo')";>
									 ...
									 <div class="form-group">
                                            ...
                                            <label for="exampleInputFile" class="col-sm-2 control-label">Update Banner 1200x900 pixel</label> 
                                             ...
                                             <div class="col-sm-8"> 
        								               <div class="input-files">
                                                         ...
                                                         <div >
                                                            ...
                                                            <input type="file" name="seller_banner" id="seller_banner" class="form-control1"  onchange="uploadFile1('seller_banner')";>
                                           ...
                                           <input type="hidden" class="form-control1" id="seller_banner1" value=<?php echo $seller_banner; ?> ></input>
										   
                                           <input type="hidden" class="form-control1" id="prod_imgurl" value=<?php echo $logo; ?> ></input>
										   
                                           <input type="hidden" class="form-control1" id="pan_card1" value=<?php echo $pan_card; ?> ></input>
                                           <input type="hidden" class="form-control1" id="aadhar_card1" value=<?php echo $aadhar_card; ?> ></input>
                                           <input type="hidden" class="form-control1" id="business_proof1" value=<?php echo $business_proof; ?> ></input>
									 <div class="form-group">
                                             
                                            <label for="exampleInputFile" class="col-sm-2 control-label">Upload Pan card (<?php echo $file_kb; ?>)</label> 
                                             ...
                                             <div class="col-sm-8"> 
        								               <div class="input-files">
                                                         ...
                                                         <div >
                                                            ...
                                                            <input type="file" name="pan_card" id="pan_card" class="form-control1"  onchange="uploadFile2('pan_card','<?php echo $image_size; ?>')";>
        							  ...
        							  <div class="form-group">
                                            ...
                                            <label for="exampleInputFile" class="col-sm-2 control-label">Upload Id Proof (<?php echo $file_kb; ?>)</label> 
                                             ...
                                             <div class="col-sm-8"> 
        								               <div class="input-files">
                                                         ...
                                                         <div >
                                                            ...
                                                            <input type="file" name="aadhar_card" id="aadhar_card" class="form-control1"  onchange="uploadFile2('aadhar_card','<?php echo $image_size; ?>')";>
										 ...
										 <div class="form-group">
                                            ...
                                            <label for="exampleInputFile" class="col-sm-2 control-label">Upload Business Proof (<?php echo $file_kb; ?>)</label> 
                                             ...
                                             <div class="col-sm-8"> 
        								               <div class="input-files">
                                                         ...
                                                         <div >
                                                            ...
                                                            <input type="file" name="business_proof" id="business_proof" class="form-control1"  onchange="uploadFile2('business_proof','<?php echo $image_size; ?>')";>
                                        ...
                                        <div class="form-group">
        									<label for="focusedinput" class="col-sm-2 control-label">Website URL</label>
        									<div class="col-sm-8">
        										<input type="text" class="form-control1" id="website" placeholder="https://www.blueappsoftware.com" value="<?php echo $website; ?>"required>
        									</div>
        								</div>
        								
        							    <div class="form-group">
        									<label for="focusedinput" class="col-sm-2 control-label">GST/VAT Number **</label>
        									<div class="col-sm-8">
        										<input type="text" class="form-control1" id="gst" placeholder="Registered GST/VAT Number"  value="<?php echo $tax; ?>" required>
        									</div>
        								</div>
        							
										 <div class="form-group">
        									<label for="focusedinput" class="col-sm-2 control-label">PAN Number**</label>
        									<div class="col-sm-8">
        										<input type="text" class="form-control1" id="pan_number" placeholder="PAN Number"  value="<?php echo $pan_number; ?>" required>
        									</div>
        								</div>
										
										 <div class="form-group">
        									<label for="focusedinput" class="col-sm-2 control-label">CIN Number **</label>
        									<div class="col-sm-8">
        										<input type="text" class="form-control1" id="cin_number" placeholder="CIN Number"  value="<?php echo $cin_number; ?>" required>
        									</div>
        								</div>
