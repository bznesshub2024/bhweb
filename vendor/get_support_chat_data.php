    ...
    try{
		...
		if($rows>0){
		  $msg = '<div class="container darker">
					<img src="'.BASEURL.'avatar_g2.jpg" alt="Avatar" class="right"  style="height:40px;width:40px;margin-top:10px">
					<p>'.$message.'</p>
			...
			while($row = $query->fetch_assoc()){
				...
				if($row['message_by'] =='ADMIN'){
					echo '<div class="container">
						<img src="'.BASEURL.'bandmember.jpg" alt="Avatar" style="height:40px;width:40px;margin-top:10px">
						<p>'.$row['message'].'</p>
