            ...
            <div class="form-three widget-shadow card card-body">
               <form class="form-horizontal" id="myform" action ="add_search_product_process.php" method="post" enctype="multipart/form-data">
                  ...
                  <div class="form-group">
                     ...
                     <div class="col-sm-8">
						 <textarea rows="6" cols="65" id="prod_short" class="form-control"  disabled placeholder="Miximum 300 letters"><?php echo $prod_desc; ?></textarea> 
                  ...
                  <div class="form-group">
                     ...
                     <div class="col-sm-8">
                        <textarea rows="6" cols="65" id="editor" class="form-control" disabled placeholder="Miximum 1000 letters"><?php echo $prod_fulldetail; ?></textarea> 
                     </div>
                  </div>
				  ...
				  <div class="form-group">
						...
						<div class="col-sm-8">
							<input type="number" class="form-control" id="prod_mrp" name="prod_mrp"  maxlength="7" placeholder="MRP ex. 214" required>
						</div>
					</div>
					<div class="form-group">
						<label for="focusedinput" class="col-sm-2 control-label">Sale Price **</label>
						<div class="col-sm-8">
							<input type="number" class="form-control" id="prod_price"  name="prod_price"   maxlength="7" placeholder="Sale Price ex. 208" required>
						</div>
					</div>
						<div class="form-group">
                  ...
                  <div class="form-group">
                     ...
                     <div class="col-sm-8">
                        <input type="text" class="form-control disabled" disabled value="<?php echo $product_hsn_code; ?>" placeholder="Product HSN code">
                     </div>
                  </div>
