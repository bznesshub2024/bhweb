...
$stmt15 = $conn->prepare("SELECT vp.id, vp.enable_status, prod_name,prod_desc,prod_fulldetail,prod_img_url,featured_img, attr_set_id,brand_id,web_url,
   		product_sku,product_visibility,product_manuf_country,product_hsn_code,prod_weight,product_video_url,return_policy_id ,
   		vp.product_mrp,vp.product_sale_price,vp.product_tax_class,vp.product_stock,vp.stock_status,vp.product_purchase_limit,vp.product_remark,vp.product_related_prod,vp.product_upsell_prod,regarding_price,
		prod_name_ar,prod_desc_ar ,prod_fulldetail_ar,vp.coupon_code,vp.seller_price
							...
							<div class="form-three widget-shadow mt-2">
								<form class="form-horizontal" id="myform" action="edit_product_process.php" method="post" enctype="multipart/form-data">
									...
									<div class="form-group row align-items-center">
										...
										<div class="col-sm-8">
											<input type="text" class="form-control disabled" id="prod_name" disabled value="<?php echo $prod_name; ?>" placeholder="Name" required>
										</div>
									</div>
									...
									<div class="form-group row align-items-center">
										...
										<div class="col-sm-8">
											<input type="text" class="form-control disabled" disabled value="<?php echo $product_sku; ?>" placeholder="SKU auto generate">
										</div>
									</div>
									<div class="form-group row align-items-center">
										<label for="focusedinput" class="col-sm-2 control-label m-0">URL key</label>
										<div class="col-sm-8">
											<input type="text" class="form-control disabled" disabled value="<?php echo $web_url; ?>" placeholder="URL auto generate">
										</div>
									</div>
									<div class="form-group row align-items-center">
									...
									<div class="form-group row align-items-center">
										...
										<div class="col-sm-8">
											<input type="number" class="form-control" id="prod_mrp" name="prod_mrp" value="<?php echo $product_mrp; ?>" maxlength="7" placeholder="MRP ex. 214" required>
										</div>
									</div>
									<div class="form-group row align-items-center">
										<label for="focusedinput" class="col-sm-2 control-label m-0">Sell Price <span class="text-danger">&#42;&#42;</span></label>
										<div class="col-sm-8">
											<input type="number" class="form-control" id="seller_price" name="seller_price" value="<?php echo $seller_price; ?>" maxlength="7" placeholder="Sale Price ex. 208" required>
										</div>
									</div>
									<div class="form-group row align-items-center">
										<label for="focusedinput" class="col-sm-2 control-label m-0">Final Price <span class="text-danger">&#42;&#42;</span></label>
										<div class="col-sm-8">
											<input type="number" class="form-control" id="prod_price" name="prod_price" readonly value="<?php echo $product_sale_price; ?>" maxlength="7" placeholder="" required>
										</div>
									</div>
									<div class="form-group row align-items-center">
									...
									<div class="form-group row align-items-center " style="display:none;"> <label class="col-sm-2 control-label m-0">Coupon Code </label>
										<div class="col-sm-8"> <select class="form-control" id="coupon_code" name="coupon_code">
												<option value="">Select Coupon</option> <?php $query = $conn->query("SELECT * FROM coupancode_vendor WHERE  activate ='active' ORDER BY sno ASC");
																						if ($query->num_rows > 0) {
																							while ($row = $query->fetch_assoc()) {																														?> <option <?php if ($coupon_code == $row['sno']) {
																																																																			echo 'selected';
																																																																		} ?> value="<?php echo $row['sno']; ?>"><?php echo $row['name']; ?></option> <?php }
																																																																																				}																											?>
											</select> </div>
									</div>
									<div class="form-group row align-items-center">
										...
										<div class="col-sm-8">
											<input type="number" class="form-control" id="prod_qty" value="<?php echo $product_stock; ?>" name="prod_qty" placeholder="stock quantity">
											<br><br>
									...
									<div class="form-group row align-items-center">
										...
										<div class="col-sm-8">
											<input type="text" class="form-control disabled" id="prod_weight" name="prod_weight" value="<?php echo $prod_weight; ?>" placeholder="Product Weight">
										</div>
									</div>
									<div class="form-group row align-items-center">
										...
										<div class="col-sm-8">
											<input type="number" class="form-control" id="prod_purchase_lmt" value="<?php echo $product_purchase_limit; ?>" name="prod_purchase_lmt" maxlength="3">
									...
									<div class="form-group row align-items-center">
										...
										<div class="col-sm-8">
											<select class="form-control disabled" id="brand_id" name="brand_id">
												<option value="">Select</option>
												<?php
												...
												?>
													<table class="table table-bordered">
														...
														<tbody>
															...
															?>
																<tr id="remove_attr_tr1"><input type="hidden" name="conf_ids[]" value="<?php echo $conf_id; ?>" style="width: 100%;">
									...
									<div class="form-group row align-items-center" >
                                         ...
                                         <div class="col-sm-8">
                                            <input type="checkbox" id="regarding_price" value='1' <?php if ($regarding_price == 1) {
                                                                                               echo "checked";
                                                                                            } ?> name="regarding_price">
                                         </div>
                                      </div>
									<div class="form-group row align-items-center">
										<label for="focusedinput" class="col-sm-2 control-label m-0">Remarks</label>
										<div class="col-sm-8">
											<input type="text" class="form-control" id="prod_remark" value="<?php echo $product_remark; ?>" name="prod_remark" placeholder="200 sold in 3 hours">
										</div>
									</div>
									<div class="form-group row align-items-center">
										<label for="exampleInputFile" class="col-sm-2 control-label m-0">Featured Images</label>
										<div class="col-sm-8">
										  <input type="file" name="featured_img" id="featured_img" class="form-control-file" onchange="uploadFile1('featured_img')" />
													...
													<div class="col-md-3">
														<div class="thumbnail">
															<div class="image view view-first">
																...
																?>
																<img height="170px" style="width: 100%; display: block;object-fit:contain" src="<?php echo $img; ?>" alt="" />
															</div>
														</div>
													</div>
													 ...
													 <div class="mr-1 mb-1" id="imgs_div<?php echo $im; ?>">
														<div class="d-flex flex-column" style="width: fit-content;">
														   ...
														   <div class="image-container">
															  <img style="display: block; height: 100px; width: auto;" src="<?php echo $img1; ?>" />
														   </div>
														</div>
													 </div>
											   <?php $im++;
									...
									<div class="form-group row align-items-center">
										...
										<div class="col-sm-8">
											<input type="text" class="form-control disabled" disabled value="<?php echo $product_video_url; ?>">
										</div>
									</div>
									<?php
