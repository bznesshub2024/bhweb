...
<div id="demo-1" class="simpleLens-gallery-container">
  <div class="simpleLens-container">
    <div class="simpleLens-big-image-container"><a data-lens-image="img/view-slider/large/rectangle-large.png" class="simpleLens-lens-image"><img src="img/view-slider/medium/Rectangle 241.png" class="simpleLens-big-image"></a></div>
  </div>
...
<div class="price text-center c-product-price">
<h1 style="color: #FF5400;">$100.00 <small> <del>MRP 120.00</del></small> </h1>
</div>
...
<!-- / quick view modal -->
     ...
     <section id="portfolio" class="portfolio" style="margin: 0 0 80px 0;">
          ...
          <div class="container">
             <h2 class="text-center"><b>People Also Buy</b></h2>
     <div class="row">
      <div class="col-lg-12">
    ...
    alert("call" +pidvalue);
      $.ajax({
        ...
        success: function(response){
          ...
          $(".c-product-full").html(prodfulldetail);
          ...
          var attrName = attrObj.length;
            ...
            if(attrName >0){
              for(j=0;j<attrName;j++){
				...
				var item_html = '';
				if(attritems_count >0){
					for(itm=0;itm<attritems_count;itm++){ 
						
						item_html += '<div>'+items[itm].itemvalue+'</div>';
					}
				}
				
				attrNameList += '<div class="attr_list">'+attrNameText+'</div>'+item_html;
                ...
                // var attrItemObj = resJSON.Information.configure_attr.itemvalue;
                // console.log( attrItemObj);
                // var attrItem = attrItemObj.length;
                // var attrNameList = '';


                // if(attrItem >0){
                //   for(j=0;j<attrItem;j++){
                //     var attrItemText = attrItemObj[j].attr_name;
                //     attrItemList += '<div>'+attrItemText+'</div>';
                    
                //     $("#product_weight_div").html(attrItemList);
                    
                //     console.log(attrItemList);
                //     console.log(attrItemText);
                //   }
                // }
          ...
          // var categoryArray = catObj.configure_attr;
          // if(categoryArray){
          //   var product_id = categoryArray.id;
          //   var attr_name = categoryArray.attr_name;

            
          //   var product_fulldetail = categoryArray.fulldetail;
          
          //   var attribute_1 = JSON.parse(configure_attr.attr_name);
            
            
          //   var product_attr = JSON.parse(categoryArray.attr);
            
          //   $("#product_weight_div").text(product_attr);
          //   $("#product_weight_div").text(attribute_1);
          ...
          // alert("prodmrp is" +prodmrp);
          // alert("prodname is" +prodname);          
          ...
          //   category_product_list += '<li class="sinle_product"><input class="singleproductID" type="hidden" value="'+pid+'"></input><input class="singleproductSKU" type="hidden" value="'+sku+'"></input><input class="singleproductSID" type="hidden" value="'+sid+'"></input><a class="aa-product-img" href="#"><img src="https://www.fleekmart.com/media/'+prodImg+'" alt="'+prodname+'"></a><h3 class="aa-product-title"><a href="#"><b>'+prodname+'</b></a></h3><p><small>Price</small></p><span class="aa-product-price-right fa fa-shopping-cart"></span><span class="aa-product-price-left">'+prodPrice+'</span><p class="aa-product-descrip"></p></li>';
          ...
          //                        var pid = $row.find(".singleproductID").val(); 
          //                        var sku = $row.find(".singleproductSKU").val(); 
          //                        var sid = $row.find(".singleproductSID").val(); 
          //                        // parentvalue = text;
          //                       alert("productID productSKU productSID"+pid+"  "+sku+"  "+sid+"  "); 
